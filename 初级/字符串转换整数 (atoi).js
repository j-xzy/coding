 ...
 * 当我们寻找到的第一个非空字符为正或者负号时，则将该符号与之后面尽可能多的连续数字组合起来，作为该整数的正负号；假如第一个非空字符是数字，则直接将其与之后**连续**的数字字符组合起来，形成整数。
...
// test
console.log(myAtoi('4') === 4);
console.log(myAtoi('   -42') === -42);
console.log(myAtoi('4193 with words') === 4193);
console.log(myAtoi('+4193 with word2s') === 4193);
console.log(myAtoi('   -42') === -42);
